...
export const translations = {
  En: {
    ...
    sendLetter: 'Send me a letter',
    phoneLabel: 'Telephone',
    phonePlaceholder: 'Input your phone number',
    phoneTitle: 'Only numbers',
    textLetter: 'Text of your letter',
  ...
  Ru: {
    ...
    profile: 'Ваш профиль',
    sendLetter: 'Отправить мне письмо',
    phoneLabel: 'Телефон',
    phonePlaceholder: 'Введите свой телефон',
    phoneTitle: 'Только цифры',
    textLetter: 'Текст вашего письма',
